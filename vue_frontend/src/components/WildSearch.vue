  ...
  export default {
    ...
    methods: {
      select (value) {
        ...
        let url = window.location.origin + '/rereco/' + value.database + '?' + value.attribute + '=' + value.value;
    ...
    computed: {
      randomPlaceholder: function() {
        const placeholders = ['E.g. "single electron miniaod"',
                              'E.g. "MINIAODSIM"',
                              'E.g. "Commissioning Aug2020"',
                              'E.g. "Cosmics RAW"'];
